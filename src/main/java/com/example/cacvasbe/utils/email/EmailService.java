...
public class EmailService {
    ...
    public String sendMailWithAttachment(EmailDetailsDto details) throws Exception {
...
if(details.getAttachment() != null) {
    ...
    public String sendFundsEmail(String username, String amount)  {
        return EmailBody.sendFunds(username,amount);
    }
    public String sendRegNotification(String username)  {
        return EmailBody.sendRegNotification(username);
    }

    public String sendLicenseNotification(String username)  {
        return EmailBody.sendLicenseNotification(username);
    }
